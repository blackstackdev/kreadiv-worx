...
export default function PortalDropPrivacyPage() {
  return (
    <main className="policy-page">
      <div className="policy-opening"><SiteHeader /><div className="shell policy-hero"><p className="eyebrow eyebrow--light"><span /> PortalDrop privacy · updated 13 September 2026</p><h1>Your files stay<br /><em>on your route.</em></h1><p>PortalDrop has no developer-operated file cloud or advertising. Optional network services and the Google QR component have their own data practices, described below.</p></div></div>
