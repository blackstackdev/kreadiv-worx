...
export default function PrivacyPage() {
  return (
    <main className="policy-page">
      <div className="policy-opening"><SiteHeader /><div className="shell policy-hero"><p className="eyebrow eyebrow--light"><span /> Privacy · updated 10 September 2026</p><h1>Local means<br /><em>local.</em></h1><p>This page states what the current website and product candidates actually do—not what a future release might do.</p></div></div>
      <article className="shell policy-article">
        ...
        <section><h2>Jobbook</h2><p>Jobbook stores customer details, quotes, invoices and manually recorded payments on your Windows PC. It has no cloud sync or payment collection. Books and backups are not encrypted by the app; protect your computer and choose backup locations carefully. Send only redacted examples when asking for support.</p></section>
        ...
        <section><h2>PromptDeck</h2><p>PromptDeck v0.3.0 stores prompts and creative metadata on the user&apos;s Android device. It has no account, advertising, analytics, cloud sync, or developer-operated prompt server.</p><p>Imports are read only after the user chooses a file, and exports are written only to a destination the user chooses. Read the <Link href="/promptdeck/privacy">complete PromptDeck privacy boundary →</Link></p></section>
